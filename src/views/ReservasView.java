...
import controlador.HotelAction;
	...
	public ReservasView() {
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				 ...
				 * ReservasView.txtFechaSalida.getDate() != null) { RegistroHuesped registro =
				 * new RegistroHuesped(); registro.setVisible(true);
				 * 
				 * int dia = ReservasView.txtFechaSalida.getDate().getDay() -
				 * ReservasView.txtFechaEntrada.getDate().getDay();
				 * 
		...
		txtValor.setBorder(new LineBorder(new Color(255, 255, 255), 0));
		panel.add(txtValor);
		txtValor.setColumns(10);

		txtFormaPago = new JComboBox<Object>();
		txtFormaPago.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				HotelAction obj = new HotelAction();
				ArrayList<TipoPago> listar = obj.listarTipoPago();
				txtFormaPago.removeAllItems();
				txtFormaPago.setModel(new DefaultComboBoxModel<Object>(new String[] { "Seleccione un tipo" }));
				for (TipoPago ins : listar) {
					txtFormaPago.addItem(ins.getNombre());
				}
			}
		});
		txtFormaPago.setModel(new DefaultComboBoxModel<Object>(new String[] { "Seleccione un tipo" }));
