...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		txtNacionalidad = new JComboBox<Object>();
		txtNacionalidad.setModel(new DefaultComboBoxModel<Object>(new String[] { "Seleccione un Pais" }));
		txtNacionalidad.setBounds(560, 350, 289, 36);
		txtNacionalidad.setBackground(SystemColor.text);
		txtNacionalidad.setBorder(new LineBorder(new Color(255, 255, 255), 1, true));
	...
	protected void llenarCombo() {
		...
		ArrayList<Pais> lista = obj.listarPais();
		txtNacionalidad.setSelectedItem(lista);

		for (Pais pa : lista) {
			txtNacionalidad.addItem(pa.getNombre());
		}
